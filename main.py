...
def addsongs():
    ...
    for s in temp_song:
        #Make sure to change this directory to where your songs are located
        s=s.replace("D:/facadade/Music_Player_Py/Songs_to_test/","")
...
def Play():
    ...
    #Make sure to change this directory to where your songs are located
    song=f'D:/facadade/Music_Player_Py/Songs_to_test/{song}'
...
def Previous():
    ...
    #Make sure to change this directory to where your songs are located
    temp2=f'D:/facadade/Music_Player_Py/Songs_to_test/{temp2}'
...
def Next():
    ...
    #Make sure to change this directory to where your songs are located
    temp=f'D:/facadade/Music_Player_Py/Songs_to_test/{temp}'
